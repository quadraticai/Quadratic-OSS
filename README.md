...
<body class="antialiased selection:bg-teal-100 selection:text-teal-900 flex flex-col min-h-screen">
    ...
    <header class="bg-stone-900 text-stone-50 py-16 px-6">
        <div class="max-w-4xl mx-auto text-center">
            ...
            <button class="bg-teal-400 text-white font-bold py-4 px-10 rounded-full hover:bg-amber-400 transition-colors shadow-lg hover:shadow-xl transform hover:-translate-y-1 duration-200">
